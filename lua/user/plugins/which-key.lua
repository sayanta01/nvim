return {
	...
	opts = {
      ...
      -- stylua: ignore
      {
        ...
        { "<leader>hh", ":lua require('harpoon.ui').toggle_quick_menu()<cr>",                   desc = "Harpoon Marks", },
        { "<leader>hm", ":lua require('harpoon.mark').add_file() vim.notify 'Marked file'<cr>", desc = "Mark to Harpoon", },
        { "<leader>hn", ":lua require('harpoon.ui').nav_next()<cr>",                            desc = "Next", },
        { "<leader>hp", ":lua require('harpoon.ui').nav_prev()<cr>",                            desc = "Prev", },
